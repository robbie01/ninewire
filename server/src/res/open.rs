use std::{fs::{File, read_dir}, future::Future, io, mem, os::unix::fs::FileExt, path::PathBuf, sync::Arc};
...
use super::*;
use crate::np::traits::{self, IsCancelSafe, cancel_safe, cancel_unsafe};
...
impl traits::OpenResource for OpenResource {
    ...
    fn write(&self, _offset: u64, data: &[u8]) -> impl Future<Output = Result<u32, Self::Error>> + IsCancelSafe + Send {
        cancel_safe(async move {
            match &self.inner {
